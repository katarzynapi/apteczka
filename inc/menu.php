<!--<H4>MENU - wybierz jedną z opcji</H4>
	<H5><ul>
		<li><a href="<?php echo $PlikGlowny; ?>?mn=1"><?php echo $Naglowki[1][1]; ?></a></li>
		<li><a href="00.php?mn=2"><?php echo $Naglowki[2][1]; ?></a></li>
		<li><a href="00.php?mn=3"><?php echo $Naglowki[3][1]; ?></a></li>
		<li><a href="00.php?mn=4"><?php echo $Naglowki[4][1]; ?></a></li>
		<li><a href="00.php?mn=5"><?php echo $Naglowki[5][1]; ?></a></li>
	</ul>
	</H5>
-->
<div class = "container">
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="">Twoja apteczka</a>
